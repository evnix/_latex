...
\section{Research Method and Specification}
 ...
 \numtitle{1}{1}{12}{1}
 \end{ganttitle}
 \ganttbar{Install Queue Server}{0}{0.5}
 \ganttbar{Benchmark Server}{0.5}{0.5}
 \ganttbar{Replace Storage Layer}{1}{3}
 \ganttbar{Re-Run Benchmarks}{4}{0.5}
 \ganttbar{Compare Benchmarks}{4.5}{1.5}
 \ganttbar{Benchmark on VM}{6}{2}
 \ganttbar{H/W failure simulation}{8}{2}
 \ganttbar{Compile research results}{10}{1}
